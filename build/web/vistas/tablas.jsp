...
<html>
    ...
    <body>
        ...
        <a href="pedido/gestionPedido.jsp" style="background-color: #4D7455; color: white; border-radius: 10px; text-decoration: none; border: solid black 2px; padding: 2px; margin-left: 10px;">Gestionar la tabla Pedido</a><label style="color: red;">*Falta por arreglar al completo</label><br><br>
